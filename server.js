...
//var url = 'mongodb://localhost:27017/whiteboard'; // local db
//var cfg = JSON.parse(fs.readFileSync('config.json', 'utf8'));
//var url = 'mongodb://' + cfg.db_username + ':' + cfg.db_password + '@ds037814.mongolab.com:37814/heroku_1cjc54ck'; // read from config.json
var url = 'mongodb://' + process.env.db_username + ':' + process.env.db_password + '@ds037814.mongolab.com:37814/heroku_1cjc54ck'; // read from heroku env
